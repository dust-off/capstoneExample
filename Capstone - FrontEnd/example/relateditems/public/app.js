...
var _relateditems = __webpack_require__(8);

var _relateditems2 = _interopRequireDefault(_relateditems);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.Related = _relateditems2.default;
...
var _relatedentry = __webpack_require__(13);

var _relatedentry2 = _interopRequireDefault(_relatedentry);
  ...
  _createClass(Related, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        this.state.related.map(function (item) {
          return _react2.default.createElement(_relatedentry2.default, {
            key: item.name,
            name: item.name,
            desc: item.desc,
            img: item.img,
...
var RelatedEntry = function (_React$Component) {
  _inherits(RelatedEntry, _React$Component);

  function RelatedEntry() {
    _classCallCheck(this, RelatedEntry);

    return _possibleConstructorReturn(this, (RelatedEntry.__proto__ || Object.getPrototypeOf(RelatedEntry)).call(this));
  }

  _createClass(RelatedEntry, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: entryStyle.paper },
        _react2.default.createElement(
          'div',
          { style: entryStyle.img },
          this.props.img
        ),
        _react2.default.createElement(
          'h1',
